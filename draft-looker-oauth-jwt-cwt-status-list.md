...
- "application/statuslist+json" for Status Lists in JSON format
- "application/statuslist+jwt" for Status Lists in JWT format
- "application/statuslist+cbor" for Status Lists in CBOR format
...
In the case of "application/statuslist+cbor" or "application/statuslist+cwt", the response MUST be of type JWT and follow the rules of [](#cwt-status-list-format).
