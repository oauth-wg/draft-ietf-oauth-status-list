...
The Status List Token MUST be encoded as a "CBOR Web Token (CWT)" according to {{RFC8392}}, the token MUST not be tagged such as with the tag defined in section 6 of {{RFC8392}} or the tag defined in section 2 of {{RFC8152}}.
